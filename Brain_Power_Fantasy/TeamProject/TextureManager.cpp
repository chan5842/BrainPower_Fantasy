...
void TextureManager::SetTextureColorMode(std::string texture_id, int R, int G, int B)
{
	SDL_SetTextureColorMod(texture_map_[texture_id], R, G, B);
}
...
void TextureManager::DrawSprite(std::string texture_id, SDL_Rect s_rect, SDL_Rect d_rect)
{
	SDL_RenderCopy(g_renderer, texture_map_[texture_id], &s_rect, &d_rect);
}
